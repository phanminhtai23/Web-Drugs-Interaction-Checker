...
import { isValidEmail, isValidPassword, isNotEmpty } from '../utils/validate'; // Import thêm isNotEmpty
...
const RegisterPage = () => {
  ...
  return (
    ...
    >
      ...
      <TextField label="Full Name" name="full_name" value={formData.full_name} onChange={handleChange} fullWidth margin="normal"        sx={{
          fontFamily: 'Roboto, Arial, sans-serif',
          '& .MuiOutlinedInput-root': {
            borderRadius: 3,
          },
        }}  />
      <TextField label="Email" name="email" value={formData.email} onChange={handleChange} fullWidth margin="normal"         sx={{
          fontFamily: 'Roboto, Arial, sans-serif',
          '& .MuiOutlinedInput-root': {
            borderRadius: 3,
          },
