    ...
    return (
        <Box sx={{ mx: "auto", px: { xs: 1, sm: 2 } }}>
            ...
            >
                <Box
                    sx={{
                        ...
                        height: "100%",
                        background:
                            "url(/path-to-hero-image.jpg) no-repeat center center",
                ...
                >
                    Tra cứu tương tác thuốc và thông tin thuốc một cách dễ dàng
                    và nhanh chóng.
                </Typography>
                <Button
                    variant="contained"
                ...
                >
                    <Box
                        sx={{
                            ...
                            height: "100%",
                            background:
                                "url(/path-to-light-background.jpg) no-repeat center center",
                            backgroundSize: "cover",
                            opacity: 0.1,
                        }}
                    />
                    ...
                    >
                        Nhập tên thuốc để tra cứu thông tin chi tiết hoặc kiểm
                        tra tương tác thuốc.
                    </Typography>
            ...
            >
                ...
                >
                    Khám phá các tính năng mạnh mẽ của ứng dụng của chúng tôi,
                    giúp bạn tra cứu thông tin thuốc và tương tác thuốc một cách
                    ...
                    {[
                        {
                            ...
                            title: "Tra cứu thuốc",
                            description:
                                "Tìm kiếm thông tin chi tiết về các loại thuốc phổ biến.",
                        ...
                        },
                        {
                            ...
                            description:
                                "Đảm bảo an toàn khi sử dụng nhiều loại thuốc cùng lúc.",
                        ...
                        },
                        {
                            ...
                            description:
                                "Lưu trữ và quản lý các đơn thuốc của bạn một cách dễ dàng.",
                            onClick: () =>
                                handleProtectedNavigation("/prescriptions"), // Yêu cầu đăng nhập
                        },
                        {
                            icon: (
                                <History
                            ...
                            description:
                                "Xem lại các tương tác thuốc đã tra cứu gần đây của bạn.",
                            onClick: () =>
                    ...
                    {[
                        {
                            ...
                            description:
                                "Nhập tên thuốc vào thanh tìm kiếm để tra cứu thông tin chi tiết.",
                        },
                        {
                            step: "2",
                            title: "Kiểm tra tương tác",
                            description:
                                "Chọn các loại thuốc để kiểm tra tương tác giữa chúng.",
                        },
                        {
                            step: "3",
                            title: "Quản lý đơn thuốc",
