...
router.get(
    ...
    interactionController.searchActiveIngredients
);

router.post(
    "/check-by-active-ingredients",
    interactionController.checkInteractionByActiveIngredients
);

router.get(
    "/by-active-ingredient",
    interactionController.getInteractionsByActiveIngredient
);
